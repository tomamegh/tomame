        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.h1 variants={heroItem} className="text-[2.7rem] sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.06] text-stone-900">
              Shop the World.
              <br />
              <span className="bg-linear-to-r from-primary via-teal-400 to-sky-400 bg-clip-text text-transparent">
                Pay in Ghana.
              </span>
            </motion.h1>
            ...
            <motion.div variants={heroItem} className="flex flex-wrap gap-3">
              <Link href="/auth/signup">
                <Button className="bg-primary rounded-sm" size="lg">Start for Free</Button>
              </Link>
            </motion.div>
