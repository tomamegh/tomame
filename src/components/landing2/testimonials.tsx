      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden">
          <AnimatePresence mode="popLayout">
            <div className="rounded-2xl border border-purple-500/10 bg-primary p-8 sm:p-10 ">
            <motion.div
              key={active}
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="w-12 h-12 rounded-full bg-white/30 flex items-center justify-center text-white text-sm font-bold">
