...
export const Input: React.FC<InputProps> = ({
  ...
  <div className="w-full">
    ...
    <input
      className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-rose-400/30 focus:border-rose-300 soft-input ${
        error
