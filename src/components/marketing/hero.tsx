            ...
            >
              <div className="flex flex-col gap-2 sm:flex-row sm:items-stretch">
                <InputGroup className="flex-1 h-12 border-stone-200 bg-white shadow-sm">
                  ...
                  className="bg-linear-to-r hidden md:flex from-amber-500 to-rose-500 px-6 text-sm font-semibold text-white shadow-[0_2px_8px_-1px_rgba(255,92,53,0.35)] hover:opacity-95 active:scale-[0.98] transition-all"
                >
                  {isSubmitting ? (
                ...
                <Button
                  ...
                  disabled={isSubmitting}
                  aria-busy={isSubmitting}
                  className="h-12 w-full md:hidden sm:w-auto bg-linear-to-r from-amber-500 to-rose-500 px-6 text-sm font-semibold text-white shadow-[0_2px_8px_-1px_rgba(255,92,53,0.35)] hover:opacity-95 active:scale-[0.98] transition-all"
                >
                  {isSubmitting ? (
                    <Spinner className="size-4" />
                  ) : (
