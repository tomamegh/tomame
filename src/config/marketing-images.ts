...
export const MARKETING_IMAGES = {
  ...
  "mk-region-us": {
    ...
    shot: "USA region card. The live lane, which should read as the most established.",
  },
  "mk-region-uk": {
    ...
    shot: "UK region card. Rendered dimmed because the lane is 'coming soon'.",
  },
  "mk-region-cn": {
    ...
    shot: "China region card. Rendered dimmed because the lane is 'coming soon'.",
  },
  "mk-delivery-photo": {
