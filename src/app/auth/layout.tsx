  ...
  return (
    <main className="min-h-screen relative flex items-center justify-center p-4 sm:p-8">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1920&q=80&auto=format')`,
      ...
      {/* Centered split card */}
      <div className="relative z-10 w-[90%] lg:w-[80%] h-[80vh] flex flex-col lg:flex-row rounded-3xl overflow-hidden shadow-[0_24px_80px_-12px_rgba(0,0,0,0.4)]">
        {/* Left branded panel */}
          ...
          <div className="relative z-10 flex flex-col justify-between p-10 xl:p-12 w-full">
            ...
            <div className="space-y-6">
              ...
              <p className="text-white/70 text-base max-w-sm">
                Transparent pricing, real-time tracking, and a platform built for modern commerce.
              </p>
        ...
        <div className="lg:hidden bg-linear-to-r from-rose-500 via-orange-500 to-amber-500 px-6 py-6 text-center">
          ...
          <p className="text-white/70 text-sm">Global product sourcing made simple</p>
        </div>
